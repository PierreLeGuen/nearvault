...
export interface StakingContract extends nearAPI.Contract {
  get_account_staked_balance(params: { account_id: string }): Promise<string>;
  get_account_unstaked_balance(params: { account_id: string }): Promise<string>;
  get_account_total_balance(params: { account_id: string }): Promise<string>;
  is_account_unstaked_balance_available(params: {
    account_id: string;
  }): Promise<boolean>;
  ...
  get_account(params: { account_id: string }): Promise<HumanReadableAccount>;
  ...
  // Owner's methods
  update_staking_key(params: {
    stake_public_key: Base58PublicKey;
  }): Promise<void>;
  update_reward_fee_fraction(params: {
    reward_fee_fraction: RewardFeeFraction;
  }): Promise<void>;
  vote(params: { voting_account_id: string; is_vote: boolean }): Promise<void>;
